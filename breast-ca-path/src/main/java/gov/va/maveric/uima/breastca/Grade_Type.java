...
public class Grade_Type extends Annotation_Type {
  ...
  public String getCategory(int addr) {
      ...
      jcas.throwFeatMissing("category", "gov.va.maveric.uima.breastca.Grade");
  ...
  public String getValue(int addr) {
      ...
      jcas.throwFeatMissing("value", "gov.va.maveric.uima.breastca.Grade");
  ...
  public String getRuleID(int addr) {
      ...
      jcas.throwFeatMissing("ruleID", "gov.va.maveric.uima.breastca.Grade");
